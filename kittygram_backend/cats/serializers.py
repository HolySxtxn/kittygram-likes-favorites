...
from .models import Cat, Achievement, AchievementCat, Like, Favorite
...
class CatSerializer(serializers.ModelSerializer):
    ...
    def get_is_liked(self, obj):
        ...
        if request and request.user.is_authenticated:
            return Like.objects.filter(user=request.user, cat=obj).exists()
        return False
...
class FavoriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Favorite
        fields = ('id', 'cat_id', 'cat_name', 'added_at', 'note')
        read_only_fields = ('id', 'cat_id', 'cat_name', 'added_at')